...
class Balance:
    ...
    Торговать можно только из free — locked зарезервирован под открытые ордеры.
    """
    free: Decimal    # Доступно для новых ордеров
    locked: Decimal  # Зарезервировано под открытые ордеры
